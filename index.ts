...
export interface IBiometryError {
    CANCELLED_BY_USER: "CANCELLED_BY_USER",
    ERROR_OBTAINING_SIGNATURE: "ERROR_OBTAINING_SIGNATURE";
    ERROR_BIOMETRIC_NO_HARDWARE: "ERROR_BIOMETRIC_NO_HARDWARE";
    ERROR_BIOMETRIC_HW_UNAVAILABLE: "ERROR_BIOMETRIC_HW_UNAVAILABLE";
    ERROR_BIOMETRIC_NONE_ENROLLED: "ERROR_BIOMETRIC_NONE_ENROLLED";
    ANDROID_VERSION_UNSUPPORTED: "ANDROID_VERSION_UNSUPPORTED";
    CREATE_KEYS_EXCEPTION: "CREATE_KEYS_EXCEPTION";
    ERROR_DELETING_KEYS: "ERROR_DELETING_KEYS";
    ERROR_INIT_KEY_STORE: "ERROR_INIT_KEY_STORE";
    ERROR_NO_ACTIVITY: "ERROR_NO_ACTIVITY";
    ERROR_UNRECOVERABLE_KEY: "ERROR_UNRECOVERABLE_KEY";
    CREATE_SIGNATURE_EXCEPTION: "CREATE_SIGNATURE_EXCEPTION";
    ERROR_CHECK_KEYS_EXIST: "ERROR_CHECK_KEYS_EXIST";
